...
class TodoRepositoryImpl(
    ...
    override suspend fun getTodos(): Result<List<Todo>> = withContext(Dispatchers.IO){
        try {
    ...
    override suspend fun getTodoById(id: Int): Result<Todo> = withContext(Dispatchers.IO) {
        try {
            ...
            if( response.success ){
                ...
                Result.Error(message = "Error al obtener la tarea con id: $id")
            }


        } catch (e: Exception){
            Result.Error(message = "Error en el servidor al obtener la tarea con id: $id", throwable = e)
        }
    }

    override suspend fun createTodo(todoUpsert: TodoUpsert): Result<Todo> = withContext(Dispatchers.IO){
        try {
            ...
            if ( response.success ){
                ...
                Result.Error(message = "Error al crear la tarea")
            }

        } catch (e: Exception) {
            Result.Error(message = "Error en el servidor al crear la tarea", throwable = e)
        }
    }



    override suspend fun updatedTodo(id: Int, todoUpsert: TodoUpsert): Result<Todo> = withContext(Dispatchers.IO){
        try {
            ...
            if ( response.success ){
                ...
                Result.Error(message = "Error al actualizar la tarea con id: $id")
            }

        } catch (e: Exception) {
            Result.Error(message = "Error en el servidor al actualizar la tarea con id: $id", throwable = e)
        }
    }
}
